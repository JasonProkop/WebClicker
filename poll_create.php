<!-- 	WebClicker.tk/poll_create.php
	Developers: Dylan Fafard, Brady Smith, Jason Prokop, Bo Don, Max Gooding
	This page is where you make a poll, you can make multiple questions of
	different types and chose answers.
--> 
...
<html>
	...
	<body>		  
		<div data-role="page" data-theme='a'>
			<?php drawHeader(); ?> <!-- Create Poll Page -->
